        ...
        <div className=" container mx-auto flex flex-col md:flex-row px-5 gap-y-10 space-y-10">
          <div className="md:w-1/2 flex justify-center place-items-center">
            <dt className="text-center md:-mt-40">
              <h1 className="text-4xl font-extrabold tracking-tighter">Contact Me</h1>
              <p>Let&apos;s get started</p>
              <ul className="flex gap-x-3 justify-center mt-5">
                <li>
                  <a
                    href="https://instagram.com/dhoniaridho"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://facebook.com/dhoniaridho"
                    target="_blank"
                    rel="noopener noreferrer">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                  <a href="https://wa.me/62881080140000" target="_blank" rel="noopener noreferrer">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/ahmad-ridhoni-921a6b205"
                    target="_blank"
                    rel="noopener noreferrer">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
